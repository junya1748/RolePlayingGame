...
namespace Cainos.PixelArtTopDown_Basic
{
    ...
    public class LayerTrigger : MonoBehaviour
    {
        ...
        private void OnTriggerExit2D(Collider2D other)
        {
            ...
            //（追加）Pixel Units - SPUM Bundle Pack Basic、描画順の書き換え
            GameObject unitroot = other.gameObject.transform.Find("UnitRoot").gameObject;
            unitroot.gameObject.GetComponent<SortingGroup>().sortingLayerName = sortingLayer;
